...
public class SeamCarver {
    ...
    private double delta_x(int x, int y) {
        ...
        return math(right, left);
    }

    private double math(Color right, Color left) {
    ...
    public static void main(String[] args) {
        Picture pic = new Picture("./Data/Pics/surf.png");
        ...
        carv.removeHorizontalSeam(carv.findHorizontalSeam());
        System.out.println(pic.width());
        System.out.println(pic.height());
    }
